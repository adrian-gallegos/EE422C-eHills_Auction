...
public class Client extends Application {
	...
	@FXML
	TextField ipAddressField, portNumber, usernameField;
	@FXML
	Button myIP, connect, createAccount, loginBtn;
	...
	public void enterAuction() throws IOException {
		...
		//String arr = raw.substring(raw.indexOf(":")+1, raw.indexOf("]"));
		//items = new ArrayList<String>(Arrays.asList(arr.split(",")));
		//items.add("yo momma");
	...
	public void createNewChatPopUp() {
		...
		try {
			root = (AnchorPane) FXMLLoader.load(Client.class.getResource("ItemInfo.fxml"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
